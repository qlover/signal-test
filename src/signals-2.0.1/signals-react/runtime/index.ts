...
import { useSyncExternalStore2 } from "../../use-sync-external-store-shim.1.2.0/dev";
 ...
 *
 * [1]
 * @see https://react.dev/reference/react/useSyncExternalStore2
 * @see
...
export function _useSignalsImplementation(
  ...
  useSyncExternalStore2(store.subscribe, store.getSnapshot, store.getSnapshot);
  store._start();
